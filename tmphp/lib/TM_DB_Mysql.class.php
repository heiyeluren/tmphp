...
{   
	 ...
	 * @return void
	 */
	function _debug_print_table($title, $index, $content_pre = false){
        echo "<b>".$title."</b>\n";
		//二维数组
		if (isset($index[0])){
     ...
     * @return void  
     */  
    function debug_table_info($table_name = ''){
     ...
     * @return void  
     */  
    function debug_sql_info(){   
        //基本信息   
        $mysql_err = $this->getError() == '' ? 'NULL' : $this->getError();   
        echo "<h3>DBCommon Debug info</h3> <hr size=1><br />\n";   
        echo "<b>Execute SQL&nbsp;: </b> ". $this->getLastSql() ."  <br />\n";   
        echo "<b>MySQL Error&nbsp;: </b> ". $mysql_err ."  <br />\n";   
